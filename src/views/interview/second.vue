            ...
            <a-row :gutter="16">
                ...
                :xs="24" :sm="24" :md="24" :lg="12" :xl="8">
                    ...
                    <div class="main">
                        ...
                        <div class="card-body">
                            <div class="second">编号: &nbsp&nbsp&nbsp {{item.ID}}</div>
...
export default class SecondClass extends Vue {
    ...
    async created() {
        ...
        this.intentList = ((await getIntentList({mainStage: 'Second', department: this.$route.name})).data).data
            .map((item: any) => {
